                        ...
                        <c:forEach items="${list}" var="cv">
                            <tr class="message-unread">
                                ...
                                <td>
                                    ...
                                    <c:if test="${cv.status==Const.CLALIMVOUCHER_CREATED || cv.status==Const.CLALIMVOUCHER_BACK}">
                                        <a href="/claim_voucher/to_update?id=${cv.id}">修改</a>
                                        <a href="/claim_voucher/submit?id=${cv.id}">提交</a>
                                    </c:if>
                                    <c:if test="${cv.status==Const.CLALIMVOUCHER_SUBMIT || cv.status==Const.CLALIMVOUCHER_RECHECK}">
                                        <a href="/claim_voucher/to_check?id=${cv.id}">审核</a>
                                    </c:if>
                                    <c:if test="${cv.status==Const.CLALIMVOUCHER_APPROVER}">
