...
<%@ page import="com.yousheng.oa.global.Const" %>
                    ...
                    <form:form id="admin-form" name="addForm" action="/claim_voucher/check" modelAttribute="record">
                        ...
                        <div class="panel-body bg-light">
                            ...
                            <div class="panel-footer text-right">
                                ...
                                <c:if test="${sessionScope.employee.post==Const.POST_FM || sessionScope.employee.post==Const.POST_GM}">
                                <button type="submit" class="button" name="dealWay" value="${Const.DEAL_PASS}" >${Const.DEAL_PASS}</button>
                                <button type="submit" class="button" name="dealWay" value="${Const.DEAL_BACK}" >${Const.DEAL_BACK}</button>
                                <button type="submit" class="button" name="dealWay" value="${Const.DEAL_REJECT}" >${Const.DEAL_REJECT}</button>
                                </c:if>
                                <c:if test="${sessionScope.employee.post==Const.POST_CASHIER}">
                                <button type="submit" class="button" name="dealWay" value="${Const.DEAL_PAID}" >${Const.DEAL_PAID}</button>
                                </c:if>
